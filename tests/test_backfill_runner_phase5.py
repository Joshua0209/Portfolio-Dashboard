...
def test_runner_persists_tpex_market_for_otc_symbol(
    ...
    monkeypatch.setattr("app.price_sources.yfinance_fetch_prices", _fake_yf_otc_only)
...
def test_runner_does_not_re_probe_cached_symbols(
    ...
    monkeypatch.setattr("app.price_sources.yfinance_fetch_prices", yf_first)
    monkeypatch.setattr("app.backfill_runner._today_iso", lambda: "2025-09-30")
    ...
    monkeypatch.setattr("app.price_sources.yfinance_fetch_prices", yf_second)
    run_tw_backfill(store, portfolio_path)
