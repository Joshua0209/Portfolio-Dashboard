...
def test_strips_project_root_path():
    """A traceback that includes /Users/.../investment/... has
    the project root replaced with <project>."""
    # Test file lives at <root>/backend/tests/legacy/test_dlq_sanitization.py;
    # walk up three parents to land on the project root the sanitizer uses.
