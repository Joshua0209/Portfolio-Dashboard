...
from invest.prices.sources import get_prices, months_in_range
...
def test_get_prices_tw_routes_to_yfinance_dot_tw(monkeypatch) -> None:
    ...
    monkeypatch.setattr("invest.prices.sources.yfinance_fetch_prices", fake_yf)
...
def test_get_prices_usd_routed_to_yfinance(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "invest.prices.sources.yfinance_fetch_prices",
