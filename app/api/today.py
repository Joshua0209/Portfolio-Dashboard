...
def reconcile_open_events():
    ...
    for e in events:
        ...
        #  - Legacy run_for_month diff: {only_in_pdf_count, only_in_overlay_count, ...}
        #  - Phase 11 audit hook:       {event_type, detail: {...}}
        # The banner branches on `event_type`; preserve both surfaces.
